...
class Gui():
    def __init__(self, root):
        ...
        # 1. 构建 azure.tcl 的正确路径（这一步已经得到了绝对路径）
        theme_path = resource_path("Azure-ttk-theme/azure/azure.tcl")
        ...
        background_image = Image.open(resource_path("atlasbg.png"))
        ...
        # default barcode file bundled with the app; resolve via resource_path so PyInstaller can find it
        self.barcode_filename = resource_path(os.path.join("barcode_files", "barcode96.txt"))
        ...
        rotateleft = Image.open(resource_path("rotateleft.png"))
        ...
        rotateright = Image.open(resource_path("rotateright.png"))
...
# ######### FIX I/J
    ...
    def count(self,which):
        ...
        # colorBar
        bar = Image.open(resource_path("colorbar.png"))
